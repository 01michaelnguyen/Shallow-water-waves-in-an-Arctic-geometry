...
function h=plot_contours(x,y,X,Y,T,S,b,s_0, n_mode, n_value, s_i_list, dim,basin_type,number_plots,plottype,plot_modes, plotwhat,w_solve_values,w_solve_values_anti, filter,partition, tau_interval_top, tau_interval_bottom)
